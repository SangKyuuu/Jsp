...
public class TransactionDTO {
	private int t_no;
	private String t_a_no; //사용자 계좌
	private int t_dist;
	private int t_amount;
	private String t_datetime;
	
	//추가필드
	private String t_a_no_to; //상대 계좌
	...
	public void setT_no(String t_no) {
		if(t_no != null) this.t_no = Integer.parseInt(t_no);
	}
	...
	public void setT_dist(String t_dist) {
		if(t_dist != null) this.t_dist = Integer.parseInt(t_dist);
	}
	...
	public void setT_amount(String t_amount) {
		if(t_amount != null) this.t_amount = Integer.parseInt(t_amount);
	}
