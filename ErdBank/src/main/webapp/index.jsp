...
<html>
	...
	<body>
		...
		<c:if test="${empty sessionScope.sessCustomer}">
			...
			<form action="/ErdBank/customer/login.do" method="post">
				<table border="1">
					...
					<tr>
						<td>이름</td>
						<td><input type="text" name="c_name" placeholder="이름을 입력 하세요"/></td>
					</tr>
					<tr>
		...
		<c:if test="${not empty sessionScope.sessCustomer}">
			<p>
				${sessionScope.sessCustomer.c_name}(${sessionScope.sessCustomer.c_no})님 반갑습니다. 서비스를 이용하시기 바랍니다<br>
