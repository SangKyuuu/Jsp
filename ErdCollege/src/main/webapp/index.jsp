	...
	<body>
		...
		<form action="/ErdCollege/student/login.do" method="post">
			<table border="1">
				...
				<tr>
					<td>이름</td>
					<td><input type="text" name="stdName" placeholder="이름을 입력 하세요"/></td>
				</tr>
				<tr>
		...
		<c:if test="${not empty sessionScope.sessStudent}">
			<p>
				${sessionScope.sessStudent.stdName}(${sessionScope.sessStudent.stdNo})님 반갑습니다. 서비스를 이용하시기 바랍니다<br>
